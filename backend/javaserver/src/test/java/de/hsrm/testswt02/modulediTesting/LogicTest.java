...
//		li = new LogicImp();
		...
		w.addStep(new Action(workflowID*100, user.getUsername(), "description"));
	...
	private void initExtension(){
		...
		w1.addStep(new Action(workflowID*100, user1.getUsername(), "description"));
		w1.addStep(new FinalStep());
		w1.setId(workflowID+1);
		
		w2 = new Workflow();
		w2.addStep(new StartStep(user2.getUsername()));
		w2.addStep(new Action(workflowID*100, user1.getUsername(), "description"));
		w2.addStep(new FinalStep());
		w2.setId(workflowID+2);
		
		w3 = new Workflow();
		w3.addStep(new StartStep(user1.getUsername()));
		w3.addStep(new Action(workflowID*100, user2.getUsername(), "description"));
