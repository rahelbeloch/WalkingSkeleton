package de.hsrm.testswt02.PersistenceTesting;
...
public class PersistenceTest {
	...
	// in order to try out DI the methods loadStep and loadMetaEntry are added to the interface 'Persistence'
	...
	public void testUpadteOnUser() throws UserNotExistentException, UserAlreadyExistsException {
		...
		//assertNotEquals(user001.getId(), db.loadUser(user001.getName()).getId());
